...
class Camera:
    ...
    def extractImagesFromFrame(self, frame):
        ...
        depth_frame2 = frame.get_depth_frame()
        ...
        # added by Sorie from https://pysource.com/2021/03/11/distance-detection-with-depth-camera-intel-realsense-d435i/#
        ...
        return depth_image, color_image, colorized_image
