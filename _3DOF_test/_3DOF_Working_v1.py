...
# #if the number of waypoints is too much (theta values)
# if(num_waypoints >= max_waypoints*8):   
#     pos = pos[:,0::8]
#     print("+++++++++Take Every 8th Value+++++++++")
#     print(pos)
# elif(num_waypoints >= max_waypoints*7):   
#     pos = pos[:,0::7]
#     print("+++++++++Take Every 7th Value+++++++++")
#     print(pos)
# elif(num_waypoints >= max_waypoints*6):   
#     pos = pos[:,0::6]
#     print("+++++++++Take Every 6th Value+++++++++")
#     print(pos)
# elif(num_waypoints 5>= max_waypoints*5):   
#     pos = pos[:,0::]
#     print("+++++++++Take Every 5th Value+++++++++")
#     print(pos)
# elif(num_waypoints >= max_waypoints*4):   
#     pos = pos[:,0::4]
#     print("+++++++++Take Every 4th Value+++++++++")
#     print(pos)
# elif(num_waypoints >= max_waypoints*3):   
#     pos = pos[:,0::3]
#     print("+++++++++Take Every 3rd Value+++++++++")
#     print(pos)
# elif(num_waypoints >= max_waypoints*2):   
#     pos = pos[:,0::2]
#     print("+++++++++Take Every 2nd Value+++++++++")
#     print(pos)
...
#desiredXYZ = np.matrix([[-0.554904582093652], [0.0327905559698084], [0.398464347287072]]) #this works

#desiredXYZ = np.matrix([[0.10], [0.40], [0.30]]) #this works
#desiredXYZ = np.matrix([[0], [0.40], [0.3]]) #this works
desiredXYZ = Point2

pos = allcalcs(desiredXYZ,Startangles)
print("===Original Position (Theta) Matrix  ====")
print(pos)
...
#updates number of waypoints
num_waypoints = np.shape(pos)[1]

#prints out info on number of joints and waypoints
