...
class RobotArm:
    def __init__(self, window=None):
        ...
        if(family_name == "Arm2"):
            ...
            self.gripper_release = -1.32
            self.gripper_hold = -0.81  
        ...
        self.tol = 0.005 #how close do you want calculations to converge
    ...
    def demo_path(self):
        ...
        Point7 = np.matrix([[dest_x], [dest_y], [0.09]])
        ...
        self.wait(4,values[0],values[1],Release = False)
        ...
        self.wait(4,values[0],values[1],Release = True)
