...
group = lookup.get_group_from_names([family_name], [mod2_name,mod3_name,mod5_name,mod6_name,mod7_name,mod8_name])
...
target_xyz = [-11.97/100.0, 3.78/100.0, 29.73/100.0]
