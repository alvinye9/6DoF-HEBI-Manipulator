...
max_waypoints = 5  #number of waypoints between start point and next point (not necessary to update every single time)
speed = 0.5 #seconds per waypoint (also not necessary to update every single time)

trajCalcValues = getTrajectory(Startangles, Point5, max_waypoints, speed) #current pos to Point 10
...
Startangles = trajCalcValues[3] #updates start angles
trajCalcValues = getTrajectory(Startangles, Point1, max_waypoints,speed) #10 -> 7
trajectory_2 = trajCalcValues[0]
num_waypoints_2 = trajCalcValues[2]

Startangles = trajCalcValues[3]
trajCalcValues = getTrajectory(Startangles, Point8, max_waypoints,speed) #7 -> 9
trajectory_3 = trajCalcValues[0]
num_waypoints_3 = trajCalcValues[2]

Startangles = trajCalcValues[3]
trajCalcValues = getTrajectory(Startangles, Point12, max_waypoints,speed) #9 -> 8
trajectory_4 = trajCalcValues[0]
num_waypoints_4 = trajCalcValues[2]

Startangles = trajCalcValues[3]
trajCalcValues = getTrajectory(Startangles, Point11, max_waypoints,speed) #8 -> 11
trajectory_5 = trajCalcValues[0]
num_waypoints_5 = trajCalcValues[2]

Startangles = trajCalcValues[3]
trajCalcValues = getTrajectory(Startangles, Point5, max_waypoints,speed) #11 -> 5
