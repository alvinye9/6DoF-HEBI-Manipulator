...
class ArUcoDetector:
    ...
    def getImageWithMarkers(input_image, detect_res):
        ...
        return image, markerCorner, markerID
...
if __name__ == '__main__':
    ...
    while True:
        ...
        color_image, mc = ArUcoDetector.getImageWithMarkers(color_image, result)
        masked_color_image, mc = ArUcoDetector.getImageWithMarkers(masked_color_image, result)
        depth_colormap, mc = ArUcoDetector.getImageWithMarkers(depth_colormap, result)
